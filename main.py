...
def send_email(receiver_email, otp):
    sender_email = "rageclown4@gmail.com"
    sender_name = "CLOWN"
    password = "xwaycuswcjazdton"
...
# UI
app = tk.CTk()
app.title("WEB CAM SECURITY")
app.geometry("750x500")

widget_width = 250

title = tk.CTkLabel(app, text="Srived Project", width=widget_width)
...
signin_button = tk.CTkButton(app, text="Sign In", command=lambda: generate_and_send_otp(email_entry), width=widget_width)
